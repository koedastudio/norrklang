...
/**
 * Access to the music library. All calls may throw
 * [studio.koeda.norrklang.subsonic.SubsonicException].
 */
interface MusicRepository {
    ...
    /**
     * In-library artists similar to [artistId] (Last.fm-backed); empty when
     * the server has no Last.fm data.
     */
     ...
     * stability). Empty when the server has no Last.fm data.
     */
